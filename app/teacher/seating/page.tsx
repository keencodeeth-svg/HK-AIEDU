...
import { LAYOUT_OPTIONS, buildStudentOptionLabel, getPerformanceTone, getStudentDisplayName, isFocusPriorityStudent, isFrontPriorityStudent } from "./utils";
                ...
                >
                  ...
                  <select
                    ...
                    onChange={(event) => {
                      ...
                      handleSeatAssignmentChange(seat.seatId, nextStudentId);
                    }}
